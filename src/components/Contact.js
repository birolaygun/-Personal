  ...
  return (
    <section className="contact">
      ...
      <div className="logo">
        ...
        <div className="logos">
          <a href="https://www.aedin.com/in/birol-ayg%C3%BCn-89a346222">
            <i className="fab fa-aedin fa-3x"></i>
          </a>

          <a href="https://twitter.com/BirolAygun2?t=SBz-f9t3f5exZsApJznISg&s=08">
          ...
          <a href="https://www.instagram.com/birolaygun2/">
